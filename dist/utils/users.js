...
function findUserByWhatsapp(_x) {
  return _findUserByWhatsapp.apply(this, arguments);
}
function _findUserByWhatsapp() {
  _findUserByWhatsapp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(wpp) {
    var results;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          console.error("Erro ao buscar usuário por Whatsapp:", _context.t0);
...
function sendCodeWpp(validateWhatsapp, code) {
  ...
  client.messages.create({
    body: "Ol\xE1 ".concat(validateWhatsapp.nome, ", \nSeu c\xF3digo de acesso ao ponto do pastel \xE9: ").concat(code),
